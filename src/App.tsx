...
const MainContent: React.FC = () => {
  ...
  // The admin panel is a standalone frontend area. Keep it outside the
  // storefront header/footer/drawers so it does not inherit customer UI.
  if (currentRoute.type === 'admin') {
    return (
      <div className="min-h-screen bg-[#FAF9F5] text-[#19191B] font-sans antialiased">
        <AdminView />
        {toasts.length > 0 && (
