...
import { X, Truck, Check, Package, MapPin, Phone, Mail, CreditCard, Printer, User } from 'lucide-react';
        ...
        <div className="p-5 overflow-y-auto space-y-6 flex-1 min-h-0">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-[#FAF9F5] rounded-xl border border-[#E9E6DC] text-xs font-mono text-[#19191B] focus:bg-white focus:border-[#D85A38] focus:outline-hidden"
            />
          </div>
        </div>
